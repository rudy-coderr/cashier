  ...
  <div class="email-bg">
    <div class="email-container">
      ...
      <div class="email-body">
        ...
        @if(!empty($otp))
        <p class="body-text">
          Use the one-time code below to complete your login. This code expires in 5 minutes.
        </p>

        <div class="credentials-box">
          <div class="credentials-label">One-Time Code</div>
          <div style="display:flex;align-items:center;justify-content:center;padding:18px 0">
            <div class="cred-value" style="font-size:1.75rem;letter-spacing:6px">{{ $otp }}</div>
          </div>
        </div>
        @else
        <p class="body-text">
